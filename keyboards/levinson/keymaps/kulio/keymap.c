...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  TT(_NUMPAD), KC_LCTL, KC_LALT, KC_LGUI, MO(_LOWER),  LSFT_T(KC_ESC), KC_SPC, MO(_RAISE),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, _______, KC_ENT, KC_BSPC, _______, _______, _______, _______, _______, _______  \
),
