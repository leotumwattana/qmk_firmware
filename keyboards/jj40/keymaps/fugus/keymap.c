...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  TT(_NUMPAD), KC_LCTL, KC_LALT, KC_LGUI, MO(_LOWER),  OSM(MOD_LSFT), LSFT_T(KC_SPC), MO(_RAISE),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, KC_PLUS, KC_MINS, KC_ASTR, _______, _______, _______, KC_MINS, KC_PLUS, KC_UNDS, KC_PIPE, _______, \
